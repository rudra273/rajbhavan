...
export default function PackagesClient({ data }) {
    ...
    if (!data || !data.cityData) return (
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f8fafc" }}>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", color: "#ef4444" }}>Unable to load package data</p>
        </div>
    );

    const cityPackages = data.cityData[city];
